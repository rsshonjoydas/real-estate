...
type PropertyCardType = {
  ...
  imageDimensionValues?: string;
  imageDimensionIdsAndValue?: string;
  imageDimensionIdsAndValue2?: string;
  imageDimensionIdsAndValue3?: string;
  imageDimensionIdsAndValue4?: string;
  imageDimensionIdsAndValue5?: string;
